...
public class ClimberElevatorPivot extends SubsystemBase {
  ...
  final double intermediate = 3;
  final double ready = 7;
  final double engaged = 10;

  /** Creates a new ClimberElevatorPivot. */
  public ClimberElevatorPivot(TalonFX motor) {
    this.motor = motor;
  ...
  public Command goToIntermediateCommand() {
    return setPositionCommand(intermediate);
  }
