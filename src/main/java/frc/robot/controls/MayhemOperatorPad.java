...
public class MayhemOperatorPad {
    ...
    // public final Trigger OPERATOR_PAD_BUTTON_SEVEN = new
    // JoystickButton(OPERATOR_PAD, 7);
    // public final Trigger OPERATOR_PAD_BUTTON_EIGHT = new
    // JoystickButton(OPERATOR_PAD, 8);
    // public final Trigger OPERATOR_PAD_BUTTON_NINE = new
    // JoystickButton(OPERATOR_PAD, 9);
    // public final Trigger OPERATOR_PAD_BUTTON_TEN = new
    // JoystickButton(OPERATOR_PAD, 10);
    // public final Trigger OPERATOR_PAD_BUTTON_ELEVEN = new
    // JoystickButton(OPERATOR_PAD, 11);
    // public final Trigger OPERATOR_PAD_BUTTON_TWELVE = new
    // JoystickButton(OPERATOR_PAD, 12);
    // public final Trigger FORCE_FIRE_BUTTON = new AndJoystickButton(OPERATOR_PAD,
    // 5, OPERATOR_PAD, 7);

    public final Trigger D_PAD_LEFT = new JoystickPOVButton(OPERATOR_PAD, 270);
    public final Trigger D_PAD_RIGHT = new JoystickPOVButton(OPERATOR_PAD, 90);
    public final Trigger D_PAD_UP = new JoystickPOVButton(OPERATOR_PAD, 0);
    public final Trigger D_PAD_DOWN = new JoystickPOVButton(OPERATOR_PAD, 180);

    public Trigger Button(int button) {
        return new JoystickButton(OPERATOR_PAD, button);
    }
