...
public class ClimbDownFromLowerRung extends SequentialCommandGroup {
  /** Creates a new ClimbDownFromLowerRung. */
  public ClimbDownFromLowerRung() {
    ...
    addCommands(
        ...
        climberPivot.goToStowedCommand(),
        climberShortPivot.goToStowedCommand());
  }
}
